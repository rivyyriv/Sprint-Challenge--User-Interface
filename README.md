...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
    ...
    Semantic HTML is important because it provides meaning to where element go. This helps the developer community understand your code easier.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

        display block is the default in html (it provides column styles elements)
        display inline provides row elements
...
5. Explain why git is valuable to a team of developers.
    ...
    Git provies version control ( savde on a timeline)
